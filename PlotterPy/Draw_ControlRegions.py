...
if args.Category==0:
  ...
  if str_Era != 'YearCombined':
    ...
    exec('m.SampleGroups = [SampleGroup_NonPrompt_%s,SampleGroup_Conv_%s, SampleGroup_CF_%s, SampleGroup_XG_%s, SampleGroup_WZJJ_%s, SampleGroup_WGJJ_%s, SampleGroup_WpWp_%s, SampleGroup_VV_%s,  SampleGroup_VVV_%s , SampleGroup_Other_%s  ]'%(m.DataEra,m.DataEra, m.DataEra, m.DataEra,m.DataEra, m.DataEra, m.DataEra, m.DataEra, m.DataEra, m.DataEra)) #JH : XXX sometimes you need to merge samples
  else:
    m.SampleGroups = [
  ...
  m.RegionsToDraw = [
    ...
    Region('HNL_ZG_ThreeLepton_CR', 'MuMu', PNs[0], '',  UnblindData=True, Logy=0, TLatexAlias='#splitline{#mu#mu}{ZG CR}', CutFlowCaption='Number of Events in Zmass Window (SingleMuon Trigger). Truth matching applied' ),
    Region('HNL_ZG_ThreeLepton_CR', 'EMu', PNs[0], '',  UnblindData=True, Logy=0, TLatexAlias='#splitline{e#mu}{ZG CR}', CutFlowCaption='Number of Events in Zmass Window (SingleMuon Trigger). Truth matching applied' ),
    Region('HNL_ZG_ThreeLepton_CR', 'EE', PNs[0], '',  UnblindData=True, Logy=0, TLatexAlias='#splitline{ee}{ZG CR}', CutFlowCaption='Number of Events in Zmass Window (SingleMuon Trigger). Truth matching applied' ),
    Region('HNL_WG_ThreeLepton_CR', 'MuMu', PNs[0], '',  UnblindData=True, Logy=0, TLatexAlias='#splitline{#mu#mu}{WG CR}', CutFlowCaption='Number of Events in Zmass Window (SingleMuon Trigger). Truth matching applied' ),
    Region('HNL_WG_ThreeLepton_CR', 'EMu', PNs[0], '',  UnblindData=True, Logy=0, TLatexAlias='#splitline{e#mu}{WG CR}', CutFlowCaption='Number of Events in Zmass Window (SingleMuon Trigger). Truth matching applied' ),
    Region('HNL_WG_ThreeLepton_CR', 'EE', PNs[0], '',  UnblindData=True, Logy=0, TLatexAlias='#splitline{ee}{WG CR}', CutFlowCaption='Number of Events in Zmass Window (SingleMuon Trigger). Truth matching applied' ),
