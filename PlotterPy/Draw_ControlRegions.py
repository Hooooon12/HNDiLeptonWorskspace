...
m.InputDirectory = '/data6/Users/jihkim/SKFlatOutput/'+dataset+"/"+Analyser+"/"+str_Era

m.DataDirectory = "DATA"
m.Filename_prefix = Analyser
m.Filename_suffix = ""
#m.Filename_skim = "_SkimTree_HNMultiLep"
m.Filename_data_skim = "SkimTree_Dilepton"
...
m.VariablesToDraw = [
  ...
  #Variable('nPV', 'N_{pv}',''),
  Variable('Ev_MET', '#slash{E}_{T}^{miss} (GeV)', 'GeV'),
  Variable('Ev_PuppiMET_T1', 'Puppi #slash{E}_{T}^{miss} (GeV)', 'GeV'),
  Variable('Ev_PuppiMET_T1xyCorr', 'Puppi #slash{E}_{T}^{miss} xycorr. (GeV)', 'GeV'),
  ...
  Variable('nPV', 'N_{PV}', 'GeV'),
  Variable('nPileUp', 'N_{PileUp}', 'GeV'),
